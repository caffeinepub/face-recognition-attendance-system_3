...
export class Backend implements backendInterface {
    ...
    async addRecord(arg0: string, arg1: string, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllRecords(): Promise<Array<AttendanceRecord>> {
        if (this.processError) {
            try {
    ...
    async getRecordsByDate(arg0: Time, arg1: Time): Promise<Array<AttendanceRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecordsByDate(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
